...
export const list = (
 ...
 options?: SecondParameter<typeof customAxios>) => {
    return customAxios<PageResultArticleResponse>(
...
export const create = (
 ...
 options?: SecondParameter<typeof customAxios>) => {
    return customAxios<CreateArticleResponse>(
...
export const getCreateMutationFetcher = ( options?: SecondParameter<typeof customAxios>) => {
  return (_: Key, { arg }: { arg: CreateArticleRequestBody }) => {
    return create(arg, options);
  }
}
export const getCreateMutationKey = () => [`/article`] as const;
...
export const useCreate = <TError = ErrorType<ErrorModel>>(
   options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof create>>, TError, Key, CreateArticleRequestBody, Awaited<ReturnType<typeof create>>> & { swrKey?: string }, request?: SecondParameter<typeof customAxios>}
) => {
...
export const getRemoveMutationKey = (id: number,) => [`/article/${id}`] as const;
...
export const get = (
    id: number,
 options?: SecondParameter<typeof customAxios>) => {
    return customAxios<ArticleDetailResponse>(
...
export const getUpdateMutationFetcher = (id: number, options?: SecondParameter<typeof customAxios>) => {
  return (_: Key, { arg }: { arg: UpdateArticleRequestBody }) => {
    return update(id, arg, options);
  }
}
export const getUpdateMutationKey = (id: number,) => [`/article/${id}`] as const;
...
export const useUpdate = <TError = ErrorType<ErrorModel>>(
  id: number, options?: { swr?:SWRMutationConfiguration<Awaited<ReturnType<typeof update>>, TError, Key, UpdateArticleRequestBody, Awaited<ReturnType<typeof update>>> & { swrKey?: string }, request?: SecondParameter<typeof customAxios>}
) => {
